...
class MainTest {
	...
	//Los 3 tests nos da mal porque sigue dando los mismos problemas que antes, y lo comentamos en el sitio correspondiente
	//en los tests anteriores, que los calculos de velocidad, distancia, contaminacion, etc... estan mal 
